...
export default function Weak({ types }) {
  const result = [];
  ...
  // Filtra os tipos com valor de efetividade inferior a 1
  const filteredTypes = mergedItems.filter((type) => type.value < 1);

  return (
    <div>
      <h4>Fracos Contra</h4>
      <div className='effectiveness'>
        {/* Renderiza os tipos fracos */}
